...
-- DROP TABLE IF EXISTS myshop.tb_content_category;
CREATE TABLE myshop.tb_content_category(
	...
	PRIMARY KEY (id)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT 'myshop.tb_content_category';
